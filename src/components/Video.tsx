        ...
        <div className="flex-1">
            ...
            <div className="p-8 max-w[1100px] mx-auto ">
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            ...
                            src="https://github.com/Jonatas-Serra.png" 
                            alt="" />
                        </div>
                        <strong className="font-bold text-2xl block">Jonatas Serra</strong>
                        <span className="text-gray-200 text-sm block">Front-end</span>
                    </div>
                ...
                <div className="gap-8 mt-20 grid grid-cols-2">
                    ...
                    >
                        <div className=" bg-green-700 h-full p-8 flex items-center">
